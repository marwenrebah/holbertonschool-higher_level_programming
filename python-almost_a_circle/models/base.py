...
class Base:
    ...
    def __init__(self, id=None):
        """Initialize id. If id is not None, use it. Otherwise,
        increment nb_objects and assign its value to id"""
        if id is not None:
            self.id = id
        else:
            Base.__nb_objects += 1
    ...
    def from_json_string(json_string):
        """Return the list of instances from the JSON string representation"""
